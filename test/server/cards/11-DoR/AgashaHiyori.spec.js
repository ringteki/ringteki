    ...
    integration(function() {
        ...
        describe('Agasha Hiyori\'s ability', function() {
            ...
            it('should pay fate to an unclaimed ring', function() {
                ...
                expect(this.getChatLogs(1)).toContain('player1 uses Agasha Hiyori, placing 1 fate on the Air Ring to treat Court Mask as if its printed text box were blank and as if it had no skill modifiers until the end of the phase');
            });
