describe('K-PG Boundary', function () {
    integration(function () {
        beforeEach(function () {
            ...
            this.kpgBoundary = this.player2.findCardByName('k-pg-boundary', 'province 1');
        });
        ...
        it('moves fate around', function () {
            ...
            this.initiateConflict({
                ...
                province: this.kpgBoundary
            });

            this.player2.clickCard(this.kpgBoundary);
