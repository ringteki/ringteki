describe('Giants Causeway', function () {
    integration(function () {
        beforeEach(function () {
            ...
            this.giantsCauseway = this.player2.findCardByName('giants-causeway', 'province 1');
        });
        ...
        it('switches the location of opponent\'s characters', function () {
            ...
            this.initiateConflict({
                ...
                province: this.giantsCauseway
            });

            this.player2.clickCard(this.giantsCauseway);
            ...
            expect(this.getChatLogs(3)).toContain(
                'player2 uses Giants Causeway to move Aggressive Moto home, and move Utaku Tetsuko to the conflict'
            );
        });
        ...
        it('switches the location of own characters', function () {
            ...
            expect(this.getChatLogs(3)).toContain(
                'player2 uses Giants Causeway to move Togashi Yokuni home, and move Doomed Shugenja to the conflict'
            );
        });
    });
});
