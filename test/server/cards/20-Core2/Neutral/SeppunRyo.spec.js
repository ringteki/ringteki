    ...
    integration(function() {
        describe('Ignore skill', function () {
            ...
            it('refusal condition - should be allowable if opponent has the imperial favor', function() {
                ...
                expect(this.getChatLogs(5)).toContain('player2 uses Seppun Ryo to initiate a military duel : Seppun Ryo vs. Kakita Yoshi');
                expect(this.getChatLogs(5)).toContain('player1 chooses to refuse the duel and give the imperial favor to player2');
