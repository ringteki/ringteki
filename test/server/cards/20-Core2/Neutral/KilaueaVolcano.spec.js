describe('Salar the Uyuni', function () {
    integration(function () {
        beforeEach(function () {
            ...
            this.kilaueaVolcano = this.player2.findCardByName('kilauea-volcano', 'province 1');
        ...
        it('removes all attachments from a participating character', function () {
            ...
            this.initiateConflict({
                ...
                province: this.kilaueaVolcano
            });

            this.player2.clickCard(this.kilaueaVolcano);
