describe('The Door to Hell', function () {
    integration(function () {
        beforeEach(function () {
            ...
            this.doorToHell = this.player2.findCardByName('the-door-to-hell', 'province 1');
        });
        ...
        it('a lot of stuff', function () {
            ...
            this.player2.clickCard(this.doorToHell);
