describe('Sapper School', function () {
    integration(function () {
        beforeEach(function () {
            this.setupTest({
                phase: 'conflict',
                player1: {
                    dynastyDiscard: ['aranat', 'daidoji-uji', 'imperial-storehouse', 'heavy-ballista', 'sapper-school']
                },
                player2: {
            ...
            this.sapperSchool = this.player1.findCardByName('sapper-school');
            ...
            this.player1.moveCard(this.sapperSchool, 'province 2');
        ...
        it('should be usable on your own provinces', function () {
            this.player1.clickCard(this.sapperSchool);
