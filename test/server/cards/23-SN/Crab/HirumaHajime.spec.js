describe('Hiruma Hajime', function () {
    integration(function () {
        beforeEach(function () {
            this.setupTest({
                phase: 'conflict',
                player1: {
                    hand: ['total-warfare', 'fine-katana'],
                    inPlay: ['bayushi-shoju', 'hiruma-hajime'],
                    dynastyDiscard: [
                        'imperial-storehouse',
                        'favorable-ground',
                        'kakita-toshimoko',
                ...
                player2: {
                    inPlay: ['hiruma-hajime'],
                    hand: ['educated-heimin', 'prepared-ambush']
                }
            });

            this.hajime = this.player1.findCardByName('hiruma-hajime');
            this.hajime2 = this.player2.findCardByName('hiruma-hajime');
        ...
        it('should allow you to select a card in or attached to a province, whether or not it is facedown', function () {
            this.player1.clickCard(this.hajime);
        ...
        describe('Selecting a card in a province', function () {
            ...
            it('chat message - facedown card in province, facedown target, battlefield in play', function () {
                ...
                expect(this.getChatLogs(10)).toContain(
                    'player1 uses Hiruma Hajime to move a facedown card to province 1'
                );
            });
            ...
            it('chat message - faceup card in province, faceup target, battlefield in play', function () {
                ...
                this.player1.clickCard(this.assault);
                expect(this.getChatLogs(10)).toContain(
                    'player1 uses Hiruma Hajime to move Kakita Toshimoko to Dishonorable Assault'
                );
            });
            ...
            it('chat message - facedown target, battlefield not in play', function () {
                ...
                this.player1.clickCard(this.toshimoko);
                this.player1.clickCard(this.p2);
                expect(this.getChatLogs(10)).toContain('player1 uses Hiruma Hajime to move a facedown card to province 2');
            });

            describe('Flipping a card facedown', function () {
                it('faceup card moving to the attacked province', function () {
                    this.assault.facedown = false;
                    this.toshimoko.facedown = false;
                    ...
                    this.player2.clickCard(this.hajime2);
                    this.player2.clickCard(this.toshimoko);
                    this.player2.clickCard(this.assault);
                    expect(this.getChatLogs(10)).toContain(
                        'player2 uses Hiruma Hajime to move Kakita Toshimoko to Dishonorable Assault'
                    );
                    expect(this.toshimoko.facedown).toBe(false);
                    expect(this.player2).toHavePrompt('Do you want to turn Kakita Toshimoko facedown?');
                    this.player2.clickPrompt('Yes');
                    expect(this.getChatLogs(10)).toContain('player2 chooses to turn Kakita Toshimoko facedown');
                    expect(this.toshimoko.facedown).toBe(true);
                });

                it('choosing not to flip', function () {
                    this.assault.facedown = false;
                    this.toshimoko.facedown = false;
                    ...
                    expect(this.getChatLogs(10)).toContain('player2 chooses not to turn Kakita Toshimoko facedown');
                    expect(this.toshimoko.facedown).toBe(false);
                });
            });
        });
        ...
        describe('Selecting an attachment', function () {
            ...
            it('chat message - facedown target, battlefield in play', function () {
                ...
                this.player1.clickCard(this.p2_2);
                expect(this.getChatLogs(10)).toContain(
                    'player1 uses Hiruma Hajime to move Educated Heimin to province 2'
                );
            });
            ...
            it('chat message - facedown target, battlefield not in play', function () {
                ...
                this.player1.clickCard(this.heimin);
                this.player1.clickCard(this.p2_2);
                expect(this.getChatLogs(10)).toContain('player1 uses Hiruma Hajime to move Educated Heimin to province 2');
            });
            ...
            it('chat message - faceup target, battlefield in play', function () {
                ...
                this.player1.clickCard(this.p2_2);
                expect(this.getChatLogs(10)).toContain(
                    'player1 uses Hiruma Hajime to move Educated Heimin to Shameful Display'
                );
            });
        });
