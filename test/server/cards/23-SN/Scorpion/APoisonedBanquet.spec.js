describe('A Poisoned Banquet', function () {
    integration(function () {
        beforeEach(function () {
            this.setupTest({
                ...
                player1: {
                    ...
                    hand: ['fiery-madness', 'fiery-madness', 'a-poisoned-banquet', 'a-poisoned-banquet']
                },
                player2: {
            ...
            this.banquet = this.player1.filterCardsByName('a-poisoned-banquet')[0];
            this.banquet2 = this.player1.filterCardsByName('a-poisoned-banquet')[1];
        ...
        it('a second copy cannot be played in the same round', function () {
            this.player1.playAttachment(this.madness1, this.challenger);
            this.player2.playAttachment(this.madness3, this.shadows);
            this.player1.playAttachment(this.madness2, this.yoshi);
            ...
            expect(this.player1).not.toBeAbleToSelect(this.banquet2);
            expect(this.challenger.fate).toBe(1);
        });
