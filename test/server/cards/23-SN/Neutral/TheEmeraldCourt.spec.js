describe('The Emerald Court', function () {
    integration(function () {
        beforeEach(function () {
            this.setupTest({
                phase: 'dynasty',
                player1: {
                    provinces: ['the-emerald-court'],
            ...
            this.emeraldCourt = this.player1.findCardByName('the-emerald-court', 'province 1');
        ...
        it('should add 1 fate to characters played from this province', function () {
            ...
            expect(this.getChatLogs(1)).toContain('Bayushi Liar enters play with 1 additional fate due to The Emerald Court');
        });
