describe('Utaku Takeko', function () {
    integration(function () {
        describe('action ability', function () {
            ...
            it('whiffs gracefully', function () {
                this.player1.dynastyDeck.slice(0, 5).forEach((c) => {
                    this.player1.moveCard(c, 'dynasty discard pile');
                });
                ...
                expect(this.getChatLogs(5)).toContain(
                    'Utaku Takeko recalls a loved relative who is way too far to help her now'
                );
            });
        });
    });
