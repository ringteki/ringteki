        ...
        describe('action ability', function () {
            beforeEach(function () {
                this.setupTest({
                    ...
                    player2: {
                        inPlay: ['doji-whisperer', 'daidoji-uji', 'kitsuki-shomon'],
                        hand: ['to-govern-the-land']
                    }
                });
            ...
            it('during a political conflict, it allow you to target any opponent character with lower military skill than your highest power Bushi', function () {
                this.noMoreActions();
                this.initiateConflict({
                ...
                expect(this.player1).not.toBeAbleToSelect(this.toturi); // your own character
                expect(this.player1).not.toBeAbleToSelect(this.prodigy); // your own character
                expect(this.player1).not.toBeAbleToSelect(this.daisetsu); // your own character
                ...
                expect(this.getChatLogs(5)).toContain('player1 plays To Govern the Land to send Doji Whisperer home and bow Doji Whisperer');
            });

            it('during a military conflict, it allow you to target any opponent character with lower political skill than your highest power Courtier', function () {
                this.noMoreActions();
                this.initiateConflict({
                    attackers: [this.toturi, this.daisetsu, this.prodigy],
                    defenders: [this.dojiWhisperer, this.shomon, this.uji],
                ...
                expect(this.player2).not.toBeAbleToSelect(this.uji); // your own character
                expect(this.player2).not.toBeAbleToSelect(this.daisetsu); // your own character
                ...
                expect(this.getChatLogs(5)).toContain('player2 plays To Govern the Land to send Ikoma Prodigy home and bow Ikoma Prodigy');
            });
        });
    });
});
