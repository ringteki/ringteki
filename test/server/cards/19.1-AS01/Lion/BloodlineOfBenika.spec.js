describe('Bloodline of Benika', function() {
    integration(function() {
        beforeEach(function() {
            ...
            this.benika = this.player2.findCardByName('bloodline-of-benika');

            this.outrider.fate = 1;
            this.challenger.fate = 1;

            this.player1.pass();
            this.player2.playAttachment(this.benika, this.inquisitor);
        });
        ...
        it('should allow targeting a participating character eligible for the effect', function() {
            ...
            this.player2.clickCard(this.benika);
        ...
        it('should remove a fate if selected', function() {
            ...
            expect(this.benika.location).toBe('conflict discard pile');
            expect(this.getChatLogs(5)).toContain('player2 uses Bloodline of Benika, sacrificing Bloodline of Benika to remove 1 fate from Shinjo Outrider');
        });
        ...
        it('should move home if selected', function() {
            ...
            expect(this.getChatLogs(5)).toContain('player2 uses Bloodline of Benika, sacrificing Bloodline of Benika to send Shinjo Outrider home');
        });
        ...
        it('should not give you a choice if target has no fate', function() {
            ...
            expect(this.getChatLogs(5)).toContain('player2 uses Bloodline of Benika, sacrificing Bloodline of Benika to send Aggressive Moto home');
        });
