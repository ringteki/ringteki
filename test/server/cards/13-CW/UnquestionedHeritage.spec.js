describe('Unquestioned Heritage', function() {
    integration(function() {
        beforeEach(function() {
            this.setupTest({
                ...
                player1: {
                    ...
                    hand: ['fine-katana', 'cloud-the-mind', 'finger-of-jade', 'height-of-fashion', 'force-of-the-river', 'unquestioned-heritage']
                },
                player2: {
        ...
        it('should allow moving the attachment to any other character', function() {
            ...
            expect(this.rimei.attachments.toArray()).toContain(this.fan);
            expect(this.doomed.attachments.toArray()).not.toContain(this.fan);

            expect(this.getChatLogs(2)).toContain('player1 plays Unquestioned Heritage to move Ornate Fan to another character');
        ...
        it('finger of jade should not stop', function() {
            ...
            expect(this.kisada.attachments.toArray()).toContain(this.fan);
            expect(this.doomed.attachments.toArray()).not.toContain(this.fan);
        });
        ...
        it('should discard newly illegal attachments', function() {
            ...
            expect(this.getChatLogs(3)).toContain('player1 plays Unquestioned Heritage to move Force of the River to another character');
        ...
        it('should discard newly illegal attachments', function() {
            ...
            expect(this.getChatLogs(3)).toContain('player1 plays Unquestioned Heritage to move Finger of Jade to another character');
