describe('Stinger', function() {
    integration(function() {
        ...
        it('should let you attach to an attacking character', function() {
            ...
            expect(this.tadaka.attachments.toArray()).toContain(this.stinger);
            expect(this.player2.honor).toBe(honor - 1);
            expect(this.getChatLogs(5)).toContain('player2 uses Stinger, losing 1 honor to attach Stinger to Isawa Tadaka');
        });
