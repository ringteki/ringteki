describe('Soshi\'s Memory', function() {
    integration(function() {
        ...
        it('should show you a number of cards equal to shugenja you control (2) and put that card into your hand, player1 selected', function() {
            this.player1.clickCard(this.memory);
            ...
            expect(this.getChatLogs(10)).toContain('player1 takes Ornate Fan');
        ...
        it('should show your opponent a number of cards equal to shugenja you control (2), player2 selected', function() {
            ...
            expect(this.getChatLogs(10)).toContain('player2 takes Charge!');
