describe('Called to War Reprint', function() {
    integration(function() {
        beforeEach(function() {
            ...
            this.calledToWar = this.player1.findCardByName('war-calling');
        ...
        it('should allow each player to choose a bushi', function() {
            ...
            expect(this.getChatLogs(1)).toContain('player1 plays War Calling to place a fate on Matsu Berserker.  player2 gives player1 1 honor to place a fate on Shiba Tsukune');
        ...
        it('should allow opponent to choose not to select a bushi', function() {
            ...
            expect(this.getChatLogs(1)).toContain('player1 plays War Calling to place a fate on Matsu Berserker');
        ...
        it('should not allow choosing a bushi if you cannot give the honor', function() {
            ...
            expect(this.player1).not.toBeAbleToSelect(this.ikomaProdigy);
            this.player1.clickCard(this.matsuBerserker);
            expect(this.getChatLogs(3)).toContain('player1 plays War Calling to place a fate on Matsu Berserker');
        ...
        it('should work if only opponent has a bushi', function() {
            ...
            expect(this.player2).toBeAbleToSelect(this.shibaTsukune);
            this.player2.clickCard(this.shibaTsukune);
            expect(this.getChatLogs(1)).toContain('player1 plays War Calling to place a fate on Shiba Tsukune.  player2 gives player1 1 honor to place a fate on Shiba Tsukune');
