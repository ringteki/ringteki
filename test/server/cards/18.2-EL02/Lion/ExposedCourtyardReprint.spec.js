describe('Exposed Courtyard Reprint', function() {
    integration(function() {
        beforeEach(function() {
            this.setupTest({
                ...
                player1: {
                    ...
                    dynastyDiscard: ['iron-mine', 'doji-challenger', 'reexposed-courtyard']
                },
                player2: {
            ...
            this.courtyard = this.player1.placeCardInProvince('reexposed-courtyard');
        ...
        it('should discard to draw and nothing else (less honorable)', function() {
            ...
            expect(this.getChatLogs(5)).toContain('player1 uses Reexposed Courtyard, discarding Way of the Crab to draw 1 card');
        });
