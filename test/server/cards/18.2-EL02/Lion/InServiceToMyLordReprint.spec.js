    ...
    integration(function() {
        describe('In Service to My Lord\'s ability', function() {
            beforeEach(function() {
                this.setupTest({
                    ...
                    player1: {
                        ...
                        hand: [CARD_UNDER_TEST, 'sharpen-the-mind']
                    },
                    player2: {
                ...
                this.service = this.player1.findCardByName(CARD_UNDER_TEST, 'hand');
            ...
            it('should bow a non-unique to stand a unique and remove from game (should also allow you to choose an already standing unique)', function() {
                ...
                expect(this.getChatLogs(1)).toContain('player1 plays (How) To Serve my Lord, bowing Brash Samurai to ready Daidoji Uji and remove (How) To Serve my Lord from the game');
            ...
            it('should remove from game even if you stand no one', function() {
                ...
                expect(this.brashSamurai.bowed).toBe(true);
                expect(this.kakitaToshimoko.bowed).toBe(false);
                expect(this.getChatLogs(1)).toContain('player1 plays (How) To Serve my Lord, bowing Brash Samurai to ready Kakita Toshimoko and remove (How) To Serve my Lord from the game');
                expect(this.service.location).toBe('removed from game');
            });
        ...
        describe('Special Interactions (From Hand)', function() {
            beforeEach(function() {
                ...
                this.service = this.player2.findCardByName(CARD_UNDER_TEST);
            ...
            beforeEach(function() {
                this.setupTest({
                    ...
                    player2: {
                        fate: 30,
                        inPlay: ['doji-hotaru', 'doji-challenger'],
                        conflictDiscard: [CARD_UNDER_TEST]
                    }
                });
                this.hotaru = this.player2.findCardByName('doji-hotaru');
                this.dojiChallenger = this.player2.findCardByName('doji-challenger');
