describe('Ki Alignment Reprint', function() {
    integration(function() {
        beforeEach(function() {
            this.setupTest({
                ...
                player1: {
                    ...
                    hand: ['ki-realignment'],
                    conflictDiscard: ['fine-katana', 'hurricane-punch', 'centipede-tattoo', 'mantra-of-fire', 'censure', 'ornate-fan', 'ki-realignment', 'hurricane-punch', 'void-fist']
                },
                player2: {
            ...
            this.alignment = this.player1.findCardByName('ki-realignment', 'hand');
            this.alignment2 = this.player1.findCardByName('ki-realignment', 'conflict discard pile');
        ...
        it('should prompt you to pick two kihos', function() {
            ...
            expect(this.player1).toHavePromptButton('Ki Realignment');
        ...
        it('should be max 1 per round', function() {
            ...
            this.player1.clickPrompt('Hurricane Punch (2)');
            this.player1.clickPrompt('Ki Realignment');
