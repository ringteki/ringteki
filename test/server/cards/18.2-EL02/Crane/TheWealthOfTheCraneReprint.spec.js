describe('The Wealth of the Crane', function() {
    integration(function() {
        ...
        it('should let you choose characters from the top 10 cards of your deck', function() {
        ...
        it('testing chat messages', function() {
            ...
            expect(this.getChatLogs(10)).toContain('player1 plays Bird Bucks to look at the top ten cards of their dynasty deck');
        ...
        describe('Cost Reduction', function() {
            it('should cost 4 with no faceup provinces', function() {
                let fate = this.player1.fate;
                this.player1.clickCard(this.wealth);
                expect(this.player1.fate).toBe(fate - 4);
            });

            it('should cost 3 with 1 faceup province', function() {
            ...
            it('should cost 2 with 2 faceup provinces', function() {
                this.p1.facedown = false;
                this.p2.facedown = false;
                let fate = this.player1.fate;
                this.player1.clickCard(this.wealth);
            ...
            it('should cost 1 with 3 faceup provinces', function() {
                this.p1.facedown = false;
                this.p2.facedown = false;
            ...
            it('should cost 0 with 4 faceup provinces', function() {
                this.p1.facedown = false;
                this.p2.facedown = false;
                this.p3.facedown = false;
