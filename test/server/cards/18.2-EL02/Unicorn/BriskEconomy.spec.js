describe('Brisk Economy', function() {
    integration(function() {
        beforeEach(function() {
            this.setupTest({
                ...
                player1: {
                    fate: 10,
                    inPlay: ['doji-kuwanan', 'doomed-shugenja', 'blatant-swindler'],
                    hand: ['fine-katana', 'cloud-the-mind', 'finger-of-jade', 'height-of-fashion', 'force-of-the-river', 'brisk-economy']
                },
                player2: {
            ...
            this.expert = this.player1.findCardByName('brisk-economy');
        ...
        it('should prompt you to optionally give a fate to their opponent', function() {
            this.player1.clickCard(this.expert);
            expect(this.player1).toHavePrompt('Give your opponent 1 fate?');
        ...
        it('if you don\'t give a fate to their opponent should only allow targeting an attachment you control', function() {
            this.player1.clickCard(this.expert);
            this.player1.clickPrompt('No');
        ...
        it('if you give a fate to their opponent should allow targeting any attachment', function() {
            this.player1.clickCard(this.expert);
            this.player1.clickPrompt('Yes');
        ...
        it('if you don\'t give a fate to their opponent and it\'s on a merchant should allow targeting any attachment', function() {
            this.player1.moveCard(this.expert, 'hand');
            this.player1.playAttachment(this.expert, this.swindler);
            this.player2.pass();
        ...
        it('should switch with the selected attachment', function() {
            ...
            expect(this.kuwanan.attachments.toArray()).toContain(this.cloud);
            expect(this.kisada.attachments.toArray()).toContain(this.expert);

            expect(this.cloud.controller).toBe(this.player1.player);
            expect(this.expert.controller).toBe(this.player1.player);

            expect(this.getChatLogs(1)).toContain('player1 uses Brisk Economy to switch it with Cloud the Mind');
        });
        ...
        it('should switch control', function() {
            ...
            expect(this.getChatLogs(1)).toContain('player1 uses Brisk Economy to give a fate to their opponent and switch it with Ornate Fan');
        });
        ...
        it('should switch control on a attachment that must be attached to a character you control', function() {
            ...
            expect(this.kuwanan.attachments.toArray()).toContain(this.courtMask);
            expect(this.rimei.attachments.toArray()).toContain(this.expert);

            expect(this.courtMask.controller).toBe(this.player1.player);
            expect(this.expert.controller).toBe(this.player2.player);

            expect(this.getChatLogs(1)).toContain('player1 uses Brisk Economy to give a fate to their opponent and switch it with Court Mask');
        });
        ...
        it('should discard newly illegal attachments', function() {
            ...
            expect(this.getChatLogs(1)).toContain('player1 uses Brisk Economy to switch it with Force of the River');
        });

        it('should not prompt you to give a fate to their opponent if you do not have a fate', function() {
            this.player1.fate = 0;
        ...
        it('should not prompt you to give a fate to their opponent if you cannot spend the fate', function() {
            this.player1.pass();
        ...
        it('should allow using it immediately to switch back', function() {
            ...
            expect(this.getChatLogs(1)).toContain('player2 uses Brisk Economy to give a fate to their opponent and switch it with Ornate Fan');
        });
