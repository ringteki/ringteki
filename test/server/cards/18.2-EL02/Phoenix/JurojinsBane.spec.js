describe('Jurojin\'s Bane', function() {
    integration(function() {
        beforeEach(function() {
            ...
            this.yoshi.fate = 2;
            this.jurojinsCurse = this.player1.playAttachment('jurojin-s-bane', this.seeker);
        });
        ...
        it('should not trigger if it\'s parent is bowed at the end of the fate phase', function() {
            ...
            expect(this.getChatLogs(5)).not.toContain('player1 uses Jurōjin\'s Bane to discard all characters without fate and remove 1 fate from each character with fate');
        });
        ...
        it('should remove fate and discard characters', function() {
            this.seeker.fate = 1;
            this.advancePhases('fate');
            expect(this.getChatLogs(5)).toContain('player1 uses Jurōjin\'s Bane to discard all characters without fate and remove 1 fate from each character with fate');
