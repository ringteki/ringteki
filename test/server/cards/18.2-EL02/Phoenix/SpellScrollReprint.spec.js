...
describe('Spell Scroll Reprint', function () {
    integration(function () {
        ...
        it('should let you pick a non-character spell card from your discard that matches a trait on attached character, move it to hand and discard itself', function () {
            ...
            expect(this.getChatLogs(5)).toContain('player1 uses S-C-R-O-L-L to move Embrace the Void to their hand and sacrifice S-C-R-O-L-L');
        });
