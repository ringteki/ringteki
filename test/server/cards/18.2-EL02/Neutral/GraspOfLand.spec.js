describe('Grasp of Land', function() {
        ...
        beforeEach(function() {
            this.setupTest({
                ...
                player1: {
                    ...
                    hand: ['charge', 'forebearer-s-echoes', 'young-harrier', 'shosuro-miyako-2', 'grasp-of-land', 'grasp-of-land'],
            ...
            this.grasp = this.player1.filterCardsByName('grasp-of-land')[0];
            this.grasp2 = this.player1.filterCardsByName('grasp-of-land')[1];
