describe('Sulfur Mine', function() {
    integration(function() {
        beforeEach(function() {
            ...
            this.mine = this.player1.findCardByName('sulfur-mine');
        ...
        it('should cost a fate to trigger', function() {
            ...
            expect(this.getChatLogs(5)).toContain('player1 uses Sulfur Mine, spending 1 fate to prevent Vanguard Warrior from leaving play');
        });
        ...
        it('discard reaction - should prompt opponent', function() {
            ...
            expect(this.getChatLogs(5)).toContain('player2 uses Sulfur Mine to discard Sulfur Mine');
            expect(this.player1).toHavePrompt('Action Window');
        });
    });
});
