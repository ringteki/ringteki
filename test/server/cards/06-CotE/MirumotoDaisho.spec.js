    ...
    integration(function () {
        describe('Mirumoto Daisho', function () {
            ...
            it('should be attachable to all', function () {
                ...
                expect(this.mirumotoRaitsugu.attachments).toContain(this.mirumotoDaisho);
            });
            ...
            it('if character already has 2 restricted attachments, the controller should be prompted to remove one', function () {
                ...
                this.player1.clickCard(this.mirumotoRaitsugu);
                expect(this.mirumotoRaitsugu.attachments).toContain(this.fineKatana);
                this.player2.pass();
                this.player1.clickCard(this.ornateFan);
                this.player1.clickCard(this.mirumotoRaitsugu);
                expect(this.mirumotoRaitsugu.attachments).toContain(this.ornateFan);
                this.player2.pass();
                this.player1.clickCard(this.mirumotoDaisho);
                this.player1.clickCard(this.mirumotoRaitsugu);
                ...
                this.player1.clickCard(this.fineKatana);
                expect(this.mirumotoRaitsugu.attachments).not.toContain(this.fineKatana);
                expect(this.mirumotoRaitsugu.attachments).not.toContain(this.ornateFan);
                expect(this.mirumotoRaitsugu.attachments).toContain(this.mirumotoDaisho);
            ...
            it('if character already has 2 restricted attachments and the controller chooses to discard Daisho, all 3 should be discarded', function () {
                ...
                expect(this.mirumotoRaitsugu.attachments).not.toContain(this.fineKatana);
                expect(this.mirumotoRaitsugu.attachments).not.toContain(this.ornateFan);
                expect(this.mirumotoRaitsugu.attachments).not.toContain(this.mirumotoDaisho);
