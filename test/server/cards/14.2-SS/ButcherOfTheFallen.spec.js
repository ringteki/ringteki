describe('Butcher of the Fallen', function() {
    integration(function() {
        ...
        it('unbroken = 5, should not let anyone with printed mil 5 or less defend', function() {
            this.noMoreActions();
            ...
            expect(this.game.currentConflict.defenders).not.toContain(this.mil5);
            this.player2.clickCard(this.mil6);
            expect(this.game.currentConflict.defenders).toContain(this.mil6);
        });

        it('unbroken = 4, should not let anyone with printed mil 4 or less defend', function() {
        ...
        it('unbroken = 2, should not let anyone with printed mil 2 or less defend', function() {
