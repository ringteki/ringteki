...
class EventWindow extends BaseStepWithPipeline {
    ...
    initialise() {
        this.pipeline.initialise([
            ...
            new SimpleStep(this.game, () => this.checkKeywordAbilities(AbilityTypes.ForcedInterrupt)),
            ...
            new SimpleStep(this.game, () => this.checkKeywordAbilities(AbilityTypes.ForcedReaction)),
