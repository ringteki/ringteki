...
class MantraOfFire extends DrawCard {
    setupCardAbilities(ability) {
        this.reaction({
            ...
            when: {
                onConflictDeclared: (event, context) => !event.conflict.conflictPassed && event.conflict.ring.hasElement('fire') && event.conflict.attackingPlayer === context.player.opponent
            },
            target: {
