    ...
    .then((games) => {
        ...
        let factionWinRates = _.map(factions, (faction) => {
            ...
            return {
                ...
                winRate: Math.round((faction.wins / games) * 100)
            };
        });
        ...
        let factionAllianceWinners = _.chain(factionAlliances)
            .sortBy((faction) => {
                return -faction.wins;
            })
            .first(10)
        ...
        let factionAllianceWinRateStats = _.chain(factionAllianceWinRates)
            .sortBy((faction) => {
                return -faction.winRate;
            })
            .first(10)
